...
Blockskit is an easy-to-use, multi-purpose Full Site Editing theme.

== Description ==

Blockskit is modern block-based theme where you can build your own unique looking website by using WordPress Blocks Editor. No custom code required.
...
* Logo, Illustrations and Icons used in Screenshot, (C) 2023 BlockskitDev, GNU General Public License v3 http://www.gnu.org/licenses/gpl-3.0.html